...
void Packet::setSrcAddr(const char * srcAddr)
{
    this->srcAddr = srcAddr;
}

const char * Packet::getDestAddr() const
{
    return this->destAddr.c_str();
}

void Packet::setDestAddr(const char * destAddr)
{
    this->destAddr = destAddr;
}

int Packet::getForwardLabel() const
{
    return this->forwardLabel;
}

void Packet::setForwardLabel(int forwardLabel)
{
    this->forwardLabel = forwardLabel;
}

int Packet::getTraceLabel() const
{
...
int64_t Packet::getSendTime() const
{
    return this->sendTime;
}

void Packet::setSendTime(int64_t sendTime)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sendTime")==0) return base+7;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 7: return int642string(pp->getSendTime());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 7: pp->setSendTime(string2int64(value)); return true;
